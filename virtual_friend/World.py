...
class World():
    ...
    def __init__(self, data, tile_size):
        ...
        self.path_img_filename = 'path10.png'
        ...
        self.intersection_img_filename = 'intersection_path1.png'
        self.intersection_img = createListOfAnimatedImgs(World.PATH_FOR_ASSETS_FOLDER, None, self.intersection_img_filename)
        
        self.vertical_path_img_filename = 'vertical_path1.png'
        self.vertical_path_img = createListOfAnimatedImgs(World.PATH_FOR_ASSETS_FOLDER, None, self.vertical_path_img_filename)
